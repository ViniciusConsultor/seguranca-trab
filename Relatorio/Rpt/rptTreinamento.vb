...
Public Class rptTreinamento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Relatorio.rptTreinamento.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTreinamento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTreinamento = New rptTreinamento()
        rpt.Site = Me.Site
        Return rpt
    End Function
