...
#Region "Métodos públicos "
    ...
    Public Function Selecionar_Agendamento(ByVal iIdAgendamento As Integer) As System.Data.DataSet
        ...
        Try
            ...
            sSql &= " FROM  "
            sSql &= "   Agenda  "
            sSql &= " INNER JOIN Treinamento T ON T.IDTreinamento = Agenda.IdTreinamento  "
            sSql &= " INNER JOIN Treinamento_Empresa TE ON TE.IDTreinamento = T.IDTreinamento "
            sSql &= "                                  AND TE.IDEmpresa = @IDEmpresa "
    ...
    Public Function selecionarParticipantesTreinamento(ByVal iIdEmpresa As Integer,
                                                       ByVal iIdTreinamento As Integer,
                                                       ByVal iIdAgendamento As Integer,
                                                       ByVal dtDataInicial As Date,
                                                       ByVal dtDataFinal As Date,
        ...
        Try
            ...
            sSql &= "   Agenda.Data,  "
            sSql &= "   Funcionario.Nome as Funcionario,  "
            sSql &= "   Funcionario.CPF,  "
            sSql &= "   Funcionario.IDFuncionario  "
            sSql &= " FROM   "
            sSql &= "   Agenda  "
