...
#Region "Métodos públicos"
    ...
    Protected Function executarConsulta(ByRef sSql As String, _
    ...
    Protected Function executarConsulta(ByRef sSql As String) As DataTable
        Dim dsRetorno As New DataSet
    ...
    Protected Function executarConsultaCampo(ByRef sSql As String) As Object
