...
Public Class frmRelTreinamento
...
#Region "Métodos"
    ...
    Private Function validaFormulario() As Boolean
        ...
        If Not Me.chkTodosTiposTreinamentos.Checked AndAlso Me.iIdTipoTreinamento = 0 Then
            Me.epPadrao.SetError(Me.chkTodosTiposTreinamentos, "Informe o tipo do treinamento")
            bRetorno = False
        Else
            Me.epPadrao.SetError(Me.chkTodosTiposTreinamentos, "")
        End If

        If Not Me.chkTodosTreinamentos.Checked AndAlso Me.iIdAgendaTreinamento = 0 Then
            Me.epPadrao.SetError(Me.chkTodosTreinamentos, "Informe o treinamento")
            bRetorno = False
        Else
            Me.epPadrao.SetError(Me.chkTodosTreinamentos, "")
        End If
        ...
        Try
            ...
            If Me.validaFormulario Then
                ...
                With Me.objRelTreinamento
                    ...
                    .AnaliseCritica = Conversao.ToString(Me.txtAnaliseCritica.Text)
                    .Aprovacao = Conversao.ToString(Me.txtAprovacao.Text)
    ...
    Private Sub cmdLimpar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdLimparAnaliseCritica.Click
        Me.txtAnaliseCritica.Text = String.Empty
    End Sub

    Private Sub cmdLimparAprovacao_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdLimparAprovacao.Click
        Me.txtAprovacao.Text = String.Empty
    End Sub
