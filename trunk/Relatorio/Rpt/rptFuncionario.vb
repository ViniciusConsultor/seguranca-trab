...
Public Class rptFuncionario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Relatorio.rptFuncionario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFuncionario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFuncionario = New rptFuncionario()
        rpt.Site = Me.Site
        Return rpt
    End Function
